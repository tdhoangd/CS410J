...
public class PhoneBillRestClient extends HttpRequestHelper
{
     ...
     * @throws IOException
     */
    public Response searchPhoneCall(String customer, String startTime, String endTime) throws IOException {
     ...
     * @throws IOException
     */
    public Response addPhoneCall(String customer, String callerNumber, String calleeNumber, String startTime, String endTime) throws IOException{
        return post(this.url, "customer", customer, "callerNumber", callerNumber, "calleeNumber", calleeNumber, "startTime",
